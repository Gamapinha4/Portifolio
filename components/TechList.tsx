  ...
  return (
    <section className="w-full min-h-screen bg-[#1C1C1C] py-12 px-4 md:px-6 flex justify-center items-center">
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:hidden gap-4 justify-center">
          {skillCategories.map((category) => (
            <div onClick={() => openDialog(category)} className="flex flex-row items-center bg-[#2A2A2A] h-20 rounded-lg p-6 hover:bg-[#333333] transition-colors gap-2">
                <div className="p-2 rounded-lg bg-[#92E880]/10 text-[#92E880]">{<category.icon/>}</div>
